"""
Django settings for Cootpla project.
...
INSTALLED_APPS = [
    ...
    'django_apscheduler',  # pip install django_apscheduler  3.10.4
    'import_export',  # pip install django-import-export   3.3.6
    'cryptography',  # pip install cryptography 41.0.7
]
